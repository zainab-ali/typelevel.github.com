...
We can see that it's actually going to take a lot longer to get to Libra.  Perhaps it's unwise to send a person.
...
OpInt.Aux[3 * 2, 6]
```
This also gives us a conventient alias for integer singleton types
...
This is similar to the mathematic method of proof by induction.
