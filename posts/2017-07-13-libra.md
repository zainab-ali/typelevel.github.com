...
It performs compile time dimensional analysis, and allows you to roll your own dimensions.  Libra uses spire for its numeric typeclasses, so can be used for any numeric type.  It also has more advanced features, such as fractional exponents.

Take a look at [the Libra codebase](https://github.com/to-ithaca/libra) for more examples of inductive implicits.
